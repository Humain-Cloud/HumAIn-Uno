...
const categoryCapabilities: Record<string, Capability[]> = {
  ...
  'Government': [
    { title: 'Policy Impact Assessment', description: 'Analyzes proposed legislation and regulatory changes to model their economic, social, and environmental impacts on constituents, businesses, and government operations, providing evidence-based recommendations for policymakers with quantitative scenario analysis.', icon: 'Landmark' },
    { title: 'Constituent Service Automation', description: 'Automates constituent inquiry routing, response generation, and case management across multiple channels including phone, email, web portals, and social media, reducing response times while maintaining personalized service quality and compliance with public records requirements.', icon: 'Users' },
    { title: 'Procurement & Compliance', description: 'Streamlines government procurement processes by automating vendor evaluation, bid analysis, contract compliance monitoring, and small business participation tracking while ensuring adherence to competitive bidding requirements and federal acquisition regulations.', icon: 'FileCheck' },
    { title: 'Budget Allocation Optimization', description: 'Optimizes government budget allocation using data-driven analysis of program effectiveness, constituent needs, revenue projections, and statutory requirements to recommend resource distributions that maximize public value and equity across communities.', icon: 'BarChart3' },
  ],
  'Hospitality': [
    { title: 'Guest Experience Optimization', description: 'Enhances guest satisfaction through personalized stay recommendations, proactive service delivery, preference tracking, and real-time feedback analysis to create memorable experiences that drive loyalty, positive reviews, and repeat bookings.', icon: 'Heart' },
    { title: 'Revenue Management', description: 'Maximizes hotel revenue through dynamic pricing, demand forecasting, channel optimization, and rate parity management using machine learning models that account for seasonality, events, competitor pricing, and booking patterns.', icon: 'BarChart3' },
    { title: 'Operations Scheduling', description: 'Optimizes housekeeping, maintenance, and front desk staffing schedules based on occupancy forecasts, guest arrival patterns, and service level requirements to balance labor costs with guest satisfaction targets.', icon: 'Clock' },
    { title: 'Loyalty & Retention Strategy', description: 'Designs and manages guest loyalty programs using behavioral analytics, stay pattern analysis, and lifetime value modeling to personalize rewards, increase program engagement, and reduce churn across guest segments.', icon: 'Award' },
  ],
  'Pharmaceutical': [
    { title: 'Drug Discovery Assistance', description: 'Accelerates drug discovery by analyzing molecular structures, predicting drug-target interactions, identifying promising compound candidates, and optimizing lead selection using computational chemistry, molecular dynamics, and structure-activity relationship modeling.', icon: 'Pill' },
    { title: 'Clinical Trial Management', description: 'Manages clinical trial operations including patient recruitment optimization, site selection, protocol compliance monitoring, adverse event tracking, and regulatory document generation to accelerate trial timelines while maintaining data integrity and patient safety.', icon: 'ShieldCheck' },
    { title: 'Pharmacovigilance Monitoring', description: 'Continuously monitors drug safety signals from adverse event reports, literature, and real-world data sources, automating case processing, signal detection, and regulatory submission of safety reports to ensure patient safety and regulatory compliance.', icon: 'Search' },
    { title: 'Regulatory Submission Automation', description: 'Automates the preparation, compilation, and submission of regulatory documents including IND, NDA, and MAA filings with template management, cross-reference validation, and eCTD formatting to reduce submission timelines and minimize formatting errors.', icon: 'FileCheck' },
  ],
  'Telecommunications': [
    { title: 'Network Traffic Optimization', description: 'Optimizes network traffic routing, bandwidth allocation, and Quality of Service parameters using real-time traffic analysis, demand forecasting, and anomaly detection to maintain service levels and prevent congestion across mobile and fixed networks.', icon: 'Radio' },
    { title: 'Customer Churn Prediction', description: 'Predicts customer churn using usage pattern analysis, billing behavior, support interaction history, and competitive offers to identify at-risk subscribers and trigger targeted retention campaigns with personalized offers and service improvements.', icon: 'Brain' },
    { title: 'Spectrum Management', description: 'Manages wireless spectrum allocation and utilization using interference analysis, coverage modeling, demand forecasting, and regulatory compliance tracking to optimize spectrum efficiency and support network capacity planning.', icon: 'Layers' },
    { title: 'Service Outage Prediction', description: 'Predicts network service outages by analyzing equipment health indicators, environmental conditions, traffic anomalies, and historical failure patterns to enable proactive maintenance and minimize customer-impacting downtime.', icon: 'Zap' },
  ],
  'Mining & Resources': [
    { title: 'Mineral Exploration Analytics', description: 'Analyzes geological survey data, geochemical samples, and geophysical measurements to identify prospective mineral deposits, rank exploration targets, and recommend drilling programs that maximize discovery probability while minimizing exploration costs.', icon: 'Mountain' },
    { title: 'Mine Planning Optimization', description: 'Optimizes mine production schedules, cut-off grades, and pit designs using block models, geotechnical constraints, commodity price forecasts, and equipment capacity to maximize Net Present Value while maintaining safety and environmental compliance.', icon: 'Calculator' },
    { title: 'Environmental Compliance Monitoring', description: 'Monitors environmental conditions around mining operations including air quality, water discharge, noise levels, and rehabilitation progress, automating compliance reporting and alerting on threshold exceedances to maintain social license to operate.', icon: 'Leaf' },
    { title: 'Resource Estimation & Reporting', description: 'Estimates mineral resources and reserves using geostatistical methods, drill hole data interpretation, and cut-off grade optimization, generating reports compliant with JORC, NI 43-101, and SAMREC codes for investor and regulatory disclosure.', icon: 'BarChart3' },
  ],
  'Aerospace': [
    { title: 'Orbital Mechanics & Trajectory Planning', description: 'Calculates and optimizes orbital trajectories for satellites, interplanetary missions, and rendezvous operations using perturbation models, fuel optimization algorithms, and launch window analysis to minimize delta-v budgets while meeting mission constraints.', icon: 'Rocket' },
    { title: 'Satellite Health Monitoring', description: 'Continuously monitors satellite telemetry including power systems, thermal conditions, attitude control, and communication link quality, detecting anomalies, predicting component failures, and recommending corrective actions to extend mission lifetime.', icon: 'Activity' },
    { title: 'Mission Planning & Scheduling', description: 'Orchestrates complex mission timelines integrating ground station availability, orbital mechanics windows, payload operations, and crew activities with constraint-based scheduling that maximizes science return while respecting safety and resource limits.', icon: 'Clock' },
    { title: 'Aerostructural Analysis', description: 'Performs coupled aerodynamic and structural analysis of aircraft and launch vehicles using computational fluid dynamics and finite element methods, optimizing weight, performance, and safety margins across flight envelopes.', icon: 'BarChart3' },
  ],
  'Veterinary': [
    { title: 'Diagnostic Imaging Analysis', description: 'Analyzes radiographic, ultrasonographic, and MRI images from veterinary patients to detect fractures, tumors, organ abnormalities, and soft tissue injuries, providing differential diagnoses with confidence scores and recommended follow-up procedures.', icon: 'Stethoscope' },
    { title: 'Treatment Protocol Advisory', description: 'Recommends evidence-based treatment protocols for veterinary patients based on diagnosis, species-specific pharmacology, patient history, and current clinical guidelines, including drug dosages, administration routes, and monitoring parameters.', icon: 'Pill' },
    { title: 'Herd Health Management', description: 'Monitors population-level health metrics for livestock herds including vaccination coverage, disease incidence, reproduction rates, and nutrition status, identifying emerging health threats and recommending preventive interventions to optimize animal welfare and productivity.', icon: 'Heart' },
    { title: 'Zoonotic Risk Assessment', description: 'Evaluates the risk of disease transmission between animals and humans by analyzing pathogen surveillance data, species interaction patterns, and environmental conditions, providing early warning alerts and recommending biosecurity measures for at-risk populations.', icon: 'Shield' },
  ],
  'Philanthropy': [
    { title: 'Grant Proposal Evaluation', description: 'Evaluates grant proposals against foundation criteria using multi-dimensional scoring that assesses alignment with mission, organizational capacity, budget reasonableness, innovation potential, and measurable impact indicators to inform funding decisions.', icon: 'HeartHandshake' },
    { title: 'Donor Engagement Strategy', description: 'Develops personalized donor engagement strategies using giving history analysis, affinity mapping, and lifecycle modeling to optimize cultivation, stewardship, and solicitation timing for major gifts, annual fund, and planned giving programs.', icon: 'Users' },
    { title: 'Impact Measurement & Reporting', description: 'Designs and implements impact measurement frameworks using theory of change models, logic frameworks, and outcome tracking to quantify social return on investment and generate compelling impact reports for stakeholders and regulatory compliance.', icon: 'BarChart3' },
    { title: 'Foundation Compliance & Governance', description: 'Ensures philanthropic organizations maintain compliance with regulatory requirements including IRS 990 filing, minimum distribution calculations, prohibited transaction monitoring, and board governance best practices with automated deadline tracking and document generation.', icon: 'FileCheck' },
  ],
  'Logistics': [
    { title: 'Freight Rate Optimization', description: 'Optimizes freight procurement by analyzing carrier rate structures, lane performance data, market benchmarks, and capacity forecasts to negotiate favorable contracts, select optimal carriers per shipment, and minimize total transportation costs.', icon: 'Container' },
    { title: 'Cross-Dock Scheduling', description: 'Schedules and optimizes cross-dock operations by synchronizing inbound and outbound shipments, allocating dock doors, sequencing unload and load operations, and minimizing dwell time to increase throughput and reduce labor costs in high-velocity distribution.', icon: 'Clock' },
    { title: 'Last-Mile Route Optimization', description: 'Plans optimal last-mile delivery routes considering real-time traffic, delivery time windows, vehicle capacity, driver hours of service, and proof-of-delivery requirements to minimize cost per delivery while maximizing on-time performance and customer satisfaction.', icon: 'Truck' },
    { title: 'Warehouse Layout Optimization', description: 'Optimizes warehouse layout and slotting by analyzing product velocity, pick frequency, dimensional data, and order patterns to minimize travel time, maximize storage density, and improve throughput with data-driven product placement and zone configuration.', icon: 'Database' },
  ],
  'Public Safety': [
    { title: 'Emergency Response Coordination', description: 'Coordinates multi-agency emergency response by integrating real-time incident data, resource availability, personnel locations, and hazard models to dispatch optimal resources, manage incident command structure, and track response progress across jurisdictions.', icon: 'Siren' },
    { title: 'Crime Pattern Analysis', description: 'Identifies crime patterns and hotspots using geospatial analysis, temporal clustering, and predictive modeling to support intelligence-led policing, optimize patrol deployment, and enable proactive crime prevention strategies with evidence-based resource allocation.', icon: 'Search' },
    { title: 'Disaster Preparedness Planning', description: 'Develops comprehensive disaster preparedness plans by modeling hazard scenarios, mapping vulnerable populations, pre-positioning resources, and coordinating evacuation routes with real-time weather and seismic data integration for community resilience.', icon: 'Shield' },
    { title: 'Fire Risk Assessment', description: 'Assesses fire risk across urban and wildland-urban interface zones by analyzing building characteristics, vegetation density, weather patterns, and historical fire data to generate risk maps, prioritize inspections, and recommend mitigation measures for fire prevention.', icon: 'Zap' },
  ],
}
